...
/storage/public/home/2020060185/anaconda3/envs/tensorQTL/bin/python /storage/public/home/2020060185/script/eqtl_prepare_expression.py \
	...
	../sample_to_participant.list ${tis}/${group}/phenotypes/${tis} --chrs ../chrAuto.list --sample_ids ${tis}/${group}/${tis}.samplelist \
