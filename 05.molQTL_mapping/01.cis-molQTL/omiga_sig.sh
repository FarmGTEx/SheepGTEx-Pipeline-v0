...
zcat ${tis}/results/omiga/cis_lmm/${tis}.cis_qtl.txt.gz | awk 'NR==1||$NF<=0.05' | csvtk -t -j $threads cut -f 'pheno_id,pval_g1_acat' > ${tis}/results/omiga/cis_lmm/${tis}.pval_nominal_threshold
